...
/*
 * 2011/05/23 : Modification by Jerome Monceaux : bilock@gmail.com
 * Add nil type
 */
...
class XMLRPCSerializer implements IXMLRPCSerializer {
	...
	public Object deserialize(XmlPullParser parser) throws XmlPullParserException, IOException {
		...
		if (hasType) {
			...
			if (typeNodeName.equals(TYPE_NIL)) {
				obj = parser.nextText(); // JM : 2011/04/11 : obj does not support to be set to null
			} else
